...
import 'package:betatest/features/dashboard/presentation/providers/dashboard_provider.dart';
import 'package:betatest/features/dashboard/presentation/widgets/dashboard_widgets.dart';
import 'package:betatest/features/mahasiswa/presentation/pages/mahasiswa_page.dart';
import 'package:betatest/features/mahasiswa_aktif/presentation/pages/mahasiswa_aktif_page.dart';
import 'package:betatest/features/dosen/presentation/pages/dosen_page.dart';
import 'package:betatest/features/profile/presentation/pages/profile_page.dart';

class DashboardPage extends ConsumerWidget {
  const DashboardPage({Key? key}) : super(key: key);

  // Mapping judul stat ke icon
                          ...
                          itemBuilder: (context, index) {
                            ...
                            return ModernStatCard(
                              ...
                              onTap: () {
                                ...
                                // Navigasi ke halaman sesuai card
                                Widget? targetPage;
                                switch (stat.title) {
                                  case 'Total Mahasiswa':
                                ...
                                Navigator.push(
                                    context, _createRoute(targetPage));
                              },
                            );
                          },
                        ),
